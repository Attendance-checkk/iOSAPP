...
class NotificationManager: NSObject, UNUserNotificationCenterDelegate {
    ...
    lazy var notificationTest: [NotificationDataByInterval] = [
        ...
        NotificationDataByInterval(titleString: "👨‍💻 전문가 특강이 곧 시작해요!", bodyString: "산업 전문가의 이야기들을 들어보세요. 아주 중요한 내용들이 있을지도..?!", timeIntervalValue: TimeInterval(70)),
        ...
        NotificationDataByInterval(titleString: "곧 시상식과 함께 폐회식이 진행돼요!", bodyString: "마지막까지 함께해요 🥳", timeIntervalValue: TimeInterval(100))
    ]
